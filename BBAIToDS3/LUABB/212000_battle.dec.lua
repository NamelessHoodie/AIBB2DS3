...
local local23 = 2.5
function OnIf_212000(arg0, arg1, arg2)
    if arg2 == 0 then
        DarkBrigade_Sword212000_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function DarkBrigade_Sword212000Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act10)
    local1[13] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act13)
    local1[14] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act14)
    local1[15] = REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_Act15)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, DarkBrigade_Sword212000_ActAfter_AdjustSpace), local2)
    return 
end
...
local0 = local20
local0 = 4.2 - local0
function DarkBrigade_Sword212000_Act01(arg0, arg1, arg2)
...
local0 = 3.7 - local0
function DarkBrigade_Sword212000_Act02(arg0, arg1, arg2)
...
local0 = 7.3 - local0
function DarkBrigade_Sword212000_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, 0, 0, 3)
...
local0 = 4.1 - local0
function DarkBrigade_Sword212000_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, 0, 0, 3)
...
local0 = 3.6 - local0
local0 = 3.6 - local0
function DarkBrigade_Sword212000_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
local0 = local15
function DarkBrigade_Sword212000_Act06(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0
    if local2 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.1 - local0
function DarkBrigade_Sword212000_Act07(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetRandam_Int(1, 100)
...
local0 = 4.2 - local0
local0 = local20
function DarkBrigade_Sword212000_Act08(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, 0, 0, 3)
...
local0 = 5 - local0
function DarkBrigade_Sword212000_Act09(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, 0, 0, 3)
...
function DarkBrigade_Sword212000_Act10(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function DarkBrigade_Sword212000_Act13(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function DarkBrigade_Sword212000_Act14(arg0, arg1, arg2)
...
function DarkBrigade_Sword212000_Act15(arg0, arg1, arg2)
...
function DarkBrigade_Sword212000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function DarkBrigade_Sword212000_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Float(1.5, 2.5)
...
function DarkBrigade_Sword212000Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function DarkBrigade_Sword212000Battle_Terminate(arg0, arg1)
    return 
end

local0 = local15
function DarkBrigade_Sword212000Battle_Interupt(arg0, arg1)
    ...
    elseif local7 == 2 then
        ...
        if local5 <= 50 then
            arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 702, TARGET_ENE_0, 0, AI_DIR_TYPE_L, 4)
            Approach_Act(arg0, arg1, local9, local10, local11)
            arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3013, TARGET_ENE_0, local8, 0, -1)
        else
            arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 703, TARGET_ENE_0, 0, AI_DIR_TYPE_R, 4)
            Approach_Act(arg0, arg1, local9, local10, local11)
            arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3013, TARGET_ENE_0, local8, 0, -1)
