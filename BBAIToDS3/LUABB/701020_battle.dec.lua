...
function OnIf_701020(arg0, arg1, arg2)
    if arg2 == 0 then
        Avater_B_Axe701020_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function Avater_B_Axe701020Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local local6 = arg0:GetDist(TARGET_LOCALPLAYER)
    local local7 = arg0:IsSearchTarget(TARGET_ENE_0)
    local local8 = arg0:GetEventRequest(0)
    local local9 = arg0:GetEventRequest(1)
    local local10 = arg0:GetEventRequest(3)
    local local11 = arg0:GetNpcThinkParamID()
    local local12 = arg0:GetMovePointEffectRange()
    if arg0:GetNumber(3) == 1 or arg0:GetNumber(3) == 3 then
        if arg0:GetRandam_Int(1, 100) <= 10 and arg0:IsFinishTimer(0) == true then
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act05)
    local1[7] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act09)
    local1[15] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act15)
    local1[16] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act16)
    local1[18] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act18)
    local1[19] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act19)
    local1[20] = REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, Avater_B_Axe701020_ActAfter_AdjustSpace, atkAfterOddsTbl), local2)
    return 
end

local0 = 3.5 - local0
local0 = 3.5 - local0
function Avater_B_Axe701020_Act01(arg0, arg1, arg2)
...
local0 = 3.7 - local0
local0 = 3.9 - local0
function Avater_B_Axe701020_Act02(arg0, arg1, arg2)
    local local0 = 0
    local local1 = 0
    local local2 = 0
    if arg0:GetNumber(3) ~= 2 then
...
local0 = 5.4 - local0
local0 = 5.3 - local0
function Avater_B_Axe701020_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = 0
    local local2 = 0
    local local3 = 0
...
local0 = 5.9 - local0
local0 = 5.7 - local0
function Avater_B_Axe701020_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = 0
    local local2 = 0
    local local3 = 0
...
local0 = 4.6 - local0
local0 = 4.3 - local0
function Avater_B_Axe701020_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = 0
    local local2 = 0
    local local3 = 0
...
local0 = 3.5 - local0
local0 = 3.4 - local0
function Avater_B_Axe701020_Act07(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = 0
    local local2 = 0
    local local3 = 0 + 1000
...
local0 = 3.8 - local0
local0 = 3.5 - local0
function Avater_B_Axe701020_Act08(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = 0
    local local2 = 0
    local local3 = 0 + 1000
...
local0 = 4 - local0
local0 = 3.9 - local0
function Avater_B_Axe701020_Act09(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = 0
    local local2 = 0
    local local3 = 0 + 1000
...
function Avater_B_Axe701020_Act15(arg0, arg1, arg2)
...
function Avater_B_Axe701020_Act16(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function Avater_B_Axe701020_Act18(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function Avater_B_Axe701020_Act19(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetDist(TARGET_LOCALPLAYER)
    local local2 = arg0:GetRandam_Int(1, 100)
    if arg0:GetNumber(1) == 100 then
...
function Avater_B_Axe701020_Act20(arg0, arg1, arg2)
...
function Avater_B_Axe701020_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function Avater_B_Axe701020_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function Avater_B_Axe701020Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function Avater_B_Axe701020Battle_Terminate(arg0, arg1)
    return 
end

function Avater_B_Axe701020Battle_Interupt(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = arg0:GetRandam_Int(1, 100)
    local local3 = arg0:GetRandam_Int(1, 100)
