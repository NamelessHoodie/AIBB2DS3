...
function OnIf_263040(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA_knife263040_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function CrowdA_knife263040Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act05)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act11)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA_knife263040_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA_knife263040_ActAfter_AdjustSpace), local2)
    return 
end
...
local0 = local5
local0 = local7
function CrowdA_knife263040_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 3.8 - local0
function CrowdA_knife263040_Act02(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 0.5, 0, 3)
...
local0 = local10
function CrowdA_knife263040_Act03(arg0, arg1, arg2)
...
local0 = local5
local0 = local7
function CrowdA_knife263040_Act04(arg0, arg1, arg2)
...
local0 = 2.1 - local0
function CrowdA_knife263040_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = 0
    local local2 = UPVAL0
...
function CrowdA_knife263040_Act10(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = 10
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA_knife263040_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA_knife263040_ActAfter_RealTime(arg0, arg1)
    return 
end

function CrowdA_knife263040Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA_knife263040Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA_knife263040Battle_Interupt(arg0, arg1)
