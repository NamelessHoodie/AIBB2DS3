...
function OnIf_102009(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA102009_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function CrowdA102009Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    elseif local6 == 1 and arg0:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        ...
        local0[10] = 35
        local0[11] = 30
    elseif local4 == 10 then
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 30, POINT_INITIAL, 0.5, TARGET_SELF, false, -1)
    elseif local4 == 20 then
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 30, POINT_INITIAL, 0.5, TARGET_SELF, true, -1)
    elseif local4 == 90 then
        arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 30, POINT_EVENT, 0.5, TARGET_SELF, false, -1)
    elseif local4 == 91 then
        if false == arg0:IsBattleState() then
            arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 30, POINT_EVENT, 0.5, TARGET_SELF, true, -1)
        else
            COMMON_EasySetup3(arg0)
        end
    elseif local5 <= 50 and arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 90) then
        local0[20] = 100
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act11)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA102009_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA102009_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 3.1 - local0
function CrowdA102009_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 10, 0, 3)
    end
...
local0 = 2.5 - local0
function CrowdA102009_Act02(arg0, arg1, arg2)
...
local0 = 2.9 - local0
function CrowdA102009_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 10, 0, 3)
    end
...
local0 = 6.7 - local0
function CrowdA102009_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.9 - local0
function CrowdA102009_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 10, 0, 3)
    end
...
local0 = 1.8 - local0
function CrowdA102009_Act06(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 10, 0, 3)
    end
...
local0 = 2.3 - local0
function CrowdA102009_Act07(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 10, 0, 3)
    end
...
function CrowdA102009_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA102009_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA102009Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA102009Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA102009Battle_Interupt(arg0, arg1)
