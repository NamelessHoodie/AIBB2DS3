...
function OnIf_102002(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA102002_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function CrowdA102002Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act11)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act20)
    local1[21] = REGIST_FUNC(arg0, arg1, CrowdA102002_Act21)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA102002_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 3.1 - local0
function CrowdA102002_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 2.5 - local0
function CrowdA102002_Act02(arg0, arg1, arg2)
...
local0 = 2.9 - local0
function CrowdA102002_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 6.7 - local0
function CrowdA102002_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.9 - local0
function CrowdA102002_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.8 - local0
function CrowdA102002_Act06(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2.3 - local0
function CrowdA102002_Act07(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA102002_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA102002_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA102002Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA102002Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA102002Battle_Interupt(arg0, arg1)
