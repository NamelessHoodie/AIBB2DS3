...
function OnIf_102060(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA_HandAxe_and_Shield102060_ActAfter_RealTime(arg0, arg1)
    end
    if arg2 == 1 then
        arg0:SetNumber(0, 1)
    end
...
function CrowdA_HandAxe_and_Shield102060Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act06)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act11)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA_HandAxe_and_Shield102060_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 20.35 - local0
function CrowdA_HandAxe_and_Shield102060_Act01(arg0, arg1, arg2)
    local local0 = 100
    local local1 = UPVAL0
    local local2 = UPVAL0
...
local0 = 1.45 - local0
function CrowdA_HandAxe_and_Shield102060_Act02(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 1.35 - local0
function CrowdA_HandAxe_and_Shield102060_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.75 - local0
function CrowdA_HandAxe_and_Shield102060_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 16.35 - local0
function CrowdA_HandAxe_and_Shield102060_Act05(arg0, arg1, arg2)
    local local0 = 100
    local local1 = UPVAL0
    local local2 = UPVAL0
    local local3 = UPVAL0 + 2
...
local0 = 16.35 - local0
function CrowdA_HandAxe_and_Shield102060_Act06(arg0, arg1, arg2)
    local local0 = 100
    local local1 = UPVAL0
    local local2 = UPVAL0
    local local3 = UPVAL0 + 2
...
function CrowdA_HandAxe_and_Shield102060_Act10(arg0, arg1, arg2)
...
function CrowdA_HandAxe_and_Shield102060_Act11(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA_HandAxe_and_Shield102060_Act20(arg0, arg1, arg2)
...
function CrowdA_HandAxe_and_Shield102060_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA_HandAxe_and_Shield102060_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function CrowdA_HandAxe_and_Shield102060Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA_HandAxe_and_Shield102060Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA_HandAxe_and_Shield102060Battle_Interupt(arg0, arg1)
    if arg0:IsLadderAct(TARGET_SELF) then
        ...
        if arg0:IsInterupt(INTERUPT_SuccessGuard) and local3 <= 3.5 and local0 <= 50 then
            ...
            elseif arg0:GetNpcThinkParamID() <= 102064 then
                ...
                arg1:AddSubGoal(GOAL_COMMON_Attack, 10, 3021, TARGET_ENE_0, DIST_Middle, 0)
            end
            return true
