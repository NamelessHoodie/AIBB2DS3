...
function OnIf_263050(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA_Sickle263050_ActAfter_RealTime(arg0, arg1)
    end
    if arg2 == 1 then
        CrowdA_Sickle263050_StepAttack(arg0, arg1)
    end
    return 
end

function CrowdA_Sickle263050Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    if (arg0:GetNpcThinkParamID() == 263056 or arg0:GetNpcThinkParamID() == 263451) and arg0:GetNumber(0) == 0 then
        local0[4] = 100
    elseif arg0:GetNpcThinkParamID() == 263098 or arg0:GetNpcThinkParamID() == 263498 or arg0:GetNpcThinkParamID() == 263090 or arg0:GetNpcThinkParamID() == 263091 or arg0:GetNpcThinkParamID() == 263890 or arg0:GetNpcThinkParamID() == 263899 then
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act06)
    local1[9] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act11)
    local1[12] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act12)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA_Sickle263050_ActAfter_AdjustSpace), local2)
    return 
end
...
local0 = local6
local0 = local8
function CrowdA_Sickle263050_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = local10
function CrowdA_Sickle263050_Act02(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 0.5, 0, 3)
...
local0 = 2 - local0
function CrowdA_Sickle263050_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 0.5, 0, 3)
...
local0 = 4.3 - local0
function CrowdA_Sickle263050_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = local2
function CrowdA_Sickle263050_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 0.5, 0, 3)
...
function CrowdA_Sickle263050_Act06(arg0, arg1, arg2)
    local local0 = 2
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = local8
local0 = local10
function CrowdA_Sickle263050_StepAttack(arg0, arg1)
...
function CrowdA_Sickle263050_Act09(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA_Sickle263050_Act10(arg0, arg1, arg2)
    local local0 = 10
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA_Sickle263050_Act11(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 3, TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end
...
local0 = 2.2 - local0
local0 = 2.7 - local0
function CrowdA_Sickle263050_Act12(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = UPVAL0
    local local2 = UPVAL0
...
function CrowdA_Sickle263050_Act20(arg0, arg1, arg2)
...
function CrowdA_Sickle263050_StepToEscape(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA_Sickle263050_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA_Sickle263050_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    ...
    if arg0:GetExcelParam(AI_EXCEL_THINK_PARAM_TYPE__thinkAttr_doAdmirer) == 1 and arg0:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Attack then
        if local0 <= 2 then
            CrowdA_Sickle263050_StepToEscape(arg0, arg1)
...
function CrowdA_Sickle263050Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA_Sickle263050Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA_Sickle263050Battle_Interupt(arg0, arg1)
    if arg0:IsLadderAct(TARGET_SELF) then
        ...
        if arg0:IsInterupt(INTERUPT_Damaged) and arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 270) and arg0:GetRandam_Int(1, 100) <= 70 and arg0:GetNpcThinkParamID() ~= 263098 then
            arg1:ClearSubGoal()
            if arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 90) then
                arg1:AddSubGoal(GOAL_COMMON_SpinStep, 5, 701, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 0)
            elseif arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 180) then
