...
function OnIf_263010(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA_Torch_and_Shield263010_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function CrowdA_Torch_and_Shield263010Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    if arg0:GetEventRequest() == 100 then
        local0[12] = 100
    elseif arg0:GetNpcThinkParamID() == 263013 then
        if 6.5 <= local3 then
            local0[1] = 0
            local0[2] = 0
            local0[3] = 0
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act11)
    local1[12] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act12)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA_Torch_and_Shield263010_ActAfter_AdjustSpace), local2)
    return 
end

local0 = local2
function CrowdA_Torch_and_Shield263010_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 2.05 - local0
function CrowdA_Torch_and_Shield263010_Act02(arg0, arg1, arg2)
...
local0 = 6.35 - local0
function CrowdA_Torch_and_Shield263010_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2.35 - local0
function CrowdA_Torch_and_Shield263010_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.85 - local0
function CrowdA_Torch_and_Shield263010_Act06(arg0, arg1, arg2)
...
local0 = 2.45 - local0
function CrowdA_Torch_and_Shield263010_Act07(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA_Torch_and_Shield263010_Act08(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3006, TARGET_ENE_0, DIST_None, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CrowdA_Torch_and_Shield263010_Act09(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3007, TARGET_ENE_0, DIST_None, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CrowdA_Torch_and_Shield263010_Act10(arg0, arg1, arg2)
    local local0 = 10
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA_Torch_and_Shield263010_Act11(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA_Torch_and_Shield263010_Act12(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3008, TARGET_ENE_0, DIST_None, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CrowdA_Torch_and_Shield263010_Act20(arg0, arg1, arg2)
...
function CrowdA_Torch_and_Shield263010_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA_Torch_and_Shield263010_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function CrowdA_Torch_and_Shield263010Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA_Torch_and_Shield263010Battle_Terminate(arg0, arg1)
    return 
end

local0 = local2
function CrowdA_Torch_and_Shield263010Battle_Interupt(arg0, arg1)
