...
function OnIf_140000(arg0, arg1, arg2)
    if arg2 == 0 then
        IdiocySpider_Chaild140000_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function IdiocySpider_Chaild140000Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local local6 = arg0:GetTeamRecordCount(COORDINATE_TYPE_Attack, TARGET_ENE_0, 10)
    local local7 = arg0:GetTeamRecordCount(COORDINATE_TYPE_AttackOrder, TARGET_ENE_0, 10)
    ...
    elseif arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 270) then
        local0[19] = 100
    elseif arg0:GetNpcThinkParamID() == 140085 then
        if 3 <= local6 or 3 <= local7 or 3 <= local6 + local7 then
            local0[13] = 100
    ...
    elseif 3 <= local6 or 3 <= local7 or 3 <= local6 + local7 then
        local0[13] = 100
    elseif 10 <= local3 then
        local0[1] = 15
        local0[2] = 10
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act11)
    local1[12] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act12)
    local1[13] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act13)
    local1[19] = REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_Act19)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, IdiocySpider_Chaild140000_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 4 - local0
local0 = 4 - local0
function IdiocySpider_Chaild140000_Act01(arg0, arg1, arg2)
...
local0 = 3.2 - local0
function IdiocySpider_Chaild140000_Act02(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 2, 0, 3)
...
local0 = 4.5 - local0
function IdiocySpider_Chaild140000_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 2, 0, 3)
...
local0 = 4.4 - local0
function IdiocySpider_Chaild140000_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = local7
function IdiocySpider_Chaild140000_Act05(arg0, arg1, arg2)
...
local0 = 7.6 - local0
function IdiocySpider_Chaild140000_Act06(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 2, 0, 3)
...
local0 = 6.9 - local0
function IdiocySpider_Chaild140000_Act07(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
local0 = 7 - local0
function IdiocySpider_Chaild140000_Act08(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 2, 0, 3)
...
local0 = 3 - local0
function IdiocySpider_Chaild140000_Act09(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
local0 = 3.8 - local0
function IdiocySpider_Chaild140000_Act10(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 2, 0, 3)
...
local0 = 9.7 - local0
function IdiocySpider_Chaild140000_Act11(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0 + 1
    local local2 = UPVAL0
    if local2 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 4.4 - local0
function IdiocySpider_Chaild140000_Act12(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
function IdiocySpider_Chaild140000_Act13(arg0, arg1, arg2)
    ...
    if local0 == 1 and arg0:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Kankyaku then
        ...
        elseif 16 <= local1 then
            arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 10, TARGET_ENE_0, arg0:GetRandam_Float(8, 16), TARGET_SELF, true, -1)
    ...
    elseif local0 == 1 and arg0:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        ...
        elseif 16 <= local1 then
            arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 10, TARGET_ENE_0, arg0:GetRandam_Float(8, 16), TARGET_SELF, false, -1)
...
local0 = local7
function IdiocySpider_Chaild140000_Act19(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0 + 1
...
function IdiocySpider_Chaild140000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

local0 = local7
function IdiocySpider_Chaild140000_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function IdiocySpider_Chaild140000Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function IdiocySpider_Chaild140000Battle_Terminate(arg0, arg1)
    return 
end

function IdiocySpider_Chaild140000Battle_Interupt(arg0, arg1)
