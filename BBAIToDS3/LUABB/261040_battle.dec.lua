...
local local10 = 16 - local0 + 4
function OnIf_261040(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdWoman_HatchetThrow261040_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

local0 = 2
function CrowdWoman_HatchetThrow261040Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    if local4 == 200 or arg0:HasSpecialEffectId(TARGET_SELF, 5619) then
        if local3 <= 3.5 then
            local0[10] = 60
            local0[1] = 10
            local0[2] = 10
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act07)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act11)
    local1[12] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act12)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdWoman_HatchetThrow261040_ActAfter_AdjustSpace), local2)
    return 
end
...
local0 = 3.2 - local0
local0 = 3.8 - local0
function CrowdWoman_HatchetThrow261040_Act01(arg0, arg1, arg2)
...
local0 = 2.8 - local0
local0 = 3.1 - local0
function CrowdWoman_HatchetThrow261040_Act02(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 7.4 - local0
function CrowdWoman_HatchetThrow261040_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2 - local0
function CrowdWoman_HatchetThrow261040_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2.8 - local0
function CrowdWoman_HatchetThrow261040_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 0.6, 0, 3)
...
local0 = local10
function CrowdWoman_HatchetThrow261040_Act06(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
    ...
    arg1:AddSubGoal(GOAL_COMMON_Wait, arg0:GetRandam_Float(0, 2), TARGET_ENE_0, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

local0 = local10
function CrowdWoman_HatchetThrow261040_Act07(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
...
function CrowdWoman_HatchetThrow261040_Act10(arg0, arg1, arg2)
    Gather_Act(arg0, arg1, 0, 2)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CrowdWoman_HatchetThrow261040_Act11(arg0, arg1, arg2)
...
local0 = local10
function CrowdWoman_HatchetThrow261040_Act12(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3009, TARGET_EVENT, UPVAL0 + 1, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CrowdWoman_HatchetThrow261040_Act20(arg0, arg1, arg2)
...
function CrowdWoman_HatchetThrow261040_StepToEscape(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdWoman_HatchetThrow261040_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdWoman_HatchetThrow261040_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetDist(TARGET_FRI_0)
    local local2 = arg0:GetRandam_Int(1, 100)
    local local3 = arg0:GetRandam_Int(1, 100)
    local local4 = arg0:GetRandam_Int(0, 1)
    local local5 = arg0:GetRandam_Float(2, 3.5)
    local local6 = arg0:GetRandam_Float(5, 6.5)
    ...
    elseif arg0:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Attack then
        if local0 <= 1.5 then
            if local2 <= 50 then
                arg1:AddSubGoal(GOAL_COMMON_LeaveTarget, local5, TARGET_ENE_0, 15, TARGET_ENE_0, true, -1)
            end
...
function CrowdWoman_HatchetThrow261040Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdWoman_HatchetThrow261040Battle_Terminate(arg0, arg1)
    return 
end

function CrowdWoman_HatchetThrow261040Battle_Interupt(arg0, arg1)
