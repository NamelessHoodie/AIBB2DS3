...
local local2 = 1.7 - local0
local local3 = 0 - local0
local local4 = 2.4 - local0
local local5 = 0 - local0
local local6 = 0 - local0
local local7 = 2.6 - local0
...
function OnIf_250000(arg0, arg1, arg2)
    if arg2 == 0 then
        FromMoon250000_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function FromMoon250000Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    elseif 9 <= local3 then
        if not not arg0:HasSpecialEffectId(TARGET_SELF, 5609) or arg0:HasSpecialEffectId(TARGET_SELF, 5608) then
            local0[1] = 10
            local0[3] = 0
            local0[5] = 0
            local0[6] = 10
    ...
    elseif not not arg0:HasSpecialEffectId(TARGET_SELF, 5609) or arg0:HasSpecialEffectId(TARGET_SELF, 5608) then
        local0[1] = 35
        local0[3] = 0
        local0[5] = 0
        local0[6] = 30
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act11)
    local1[12] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act12)
    local1[13] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act13)
    local1[14] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act14)
    local1[15] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act15)
    local1[16] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act16)
    local1[20] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act20)
    local1[22] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act22)
    local1[23] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act23)
    local1[36] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act36)
    local1[38] = REGIST_FUNC(arg0, arg1, FromMoon250000_Act38)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, FromMoon250000_ActAfter_AdjustSpace), local2)
    return 
end
...
local0 = local4
local0 = local7
function FromMoon250000_Act01(arg0, arg1, arg2)
    ...
    if arg0:HasSpecialEffectId(TARGET_SELF, 5686) then
        ...
        Approach_Act(arg0, arg1, local2, UPVAL0 + 10.8, local3, 1.5)
    end
...
local0 = local4
function FromMoon250000_Act02(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0 + 0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 10.5, 0, 2)
    end
...
local0 = 2.1 - local0
local0 = local7
function FromMoon250000_Act03(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = UPVAL0 + 0
    local local2 = 0
    local local3 = UPVAL0
...
local0 = local7
function FromMoon250000_Act04(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2.1 - local0
function FromMoon250000_Act05(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0
    local local3 = 0
...
local0 = local10
local0 = local12
function FromMoon250000_Act06(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0 + 1.5
    local local3 = 0
    ...
    if not not arg0:HasSpecialEffectId(TARGET_SELF, 5608) or arg0:HasSpecialEffectId(TARGET_SELF, 5609) then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3005, TARGET_ENE_0, local4, 0, 180)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3006, TARGET_ENE_0, UPVAL1 + 1.5, 0)
    else
        arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3005, TARGET_ENE_0, local4, 0, 180)
    end
    if arg0:HasSpecialEffectId(TARGET_SELF, 5609) then
        GetWellSpace_Odds = 0
    else
...
local0 = local12
function FromMoon250000_Act07(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = local14
function FromMoon250000_Act08(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0
    local local3 = 0
...
local0 = 5 - local0
function FromMoon250000_Act09(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0
    local local3 = 0
...
local0 = 2.8 - local0
function FromMoon250000_Act10(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0
    local local3 = 0
...
local0 = 27.5 - local0
function FromMoon250000_Act11(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 1.5, 0, 2)
...
local0 = 27.5 - local0
function FromMoon250000_Act12(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local1, UPVAL0 + 1.5, 0, 2)
...
local0 = local4
local0 = local7
function FromMoon250000_Act13(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0 + 0
    local local3 = 0
    local local4 = UPVAL0 + 2
    local local5 = UPVAL1 + 2
    if arg0:HasSpecialEffectId(TARGET_SELF, 5686) then
        Approach_Act(arg0, arg1, 8, 999, local3, 1.5)
        Approach_Act(arg0, arg1, local2, local2, local3, 1.5)
    else
    ...
    if arg0:HasSpecialEffectId(TARGET_SELF, 5609) then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3000, TARGET_ENE_0, local4, 0, 180)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3001, TARGET_ENE_0, local5, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3003, TARGET_ENE_0, UPVAL2 + 2, 0)
    elseif arg0:HasSpecialEffectId(TARGET_SELF, 5608) then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3000, TARGET_ENE_0, local4, 0, 180)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3001, TARGET_ENE_0, local5, 0)
    else
...
local0 = local10
local0 = local12
function FromMoon250000_Act14(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
    local local2 = UPVAL0
    local local3 = 0
    ...
    if not not arg0:HasSpecialEffectId(TARGET_SELF, 5608) or arg0:HasSpecialEffectId(TARGET_SELF, 5609) then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3005, TARGET_ENE_0, local4, 0, 180)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3006, TARGET_ENE_0, UPVAL1 + 2, 0)
    else
        arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, 3005, TARGET_ENE_0, local4, 0, 180)
    end
    if arg0:HasSpecialEffectId(TARGET_SELF, 5609) then
...
function FromMoon250000_Act15(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function FromMoon250000_Act16(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Wait, 1, TARGET_ENE_0, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function FromMoon250000_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 3, TARGET_ENE_0, 30, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function FromMoon250000_Act22(arg0, arg1, arg2)
    Kanshu_Act(arg0, arg1, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function FromMoon250000_Act23(arg0, arg1, arg2)
...
local0 = local10
function FromMoon250000_Act36(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = local14
function FromMoon250000_Act38(arg0, arg1, arg2)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = UPVAL0
    if local1 <= arg0:GetDist(TARGET_ENE_0) then
...
function FromMoon250000_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetRandam_Int(1, 100)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function FromMoon250000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function FromMoon250000Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function FromMoon250000Battle_Terminate(arg0, arg1)
    return 
end

function FromMoon250000Battle_Interupt(arg0, arg1)
