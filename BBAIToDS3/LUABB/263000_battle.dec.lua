...
function OnIf_263000(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA263000_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function CrowdA263000Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act09)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act11)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA263000_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA263000_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 4.1 - local0
function CrowdA263000_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 3.7 - local0
function CrowdA263000_Act02(arg0, arg1, arg2)
...
local0 = 4.8 - local0
function CrowdA263000_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 5 - local0
function CrowdA263000_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2.6 - local0
function CrowdA263000_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 1.3 - local0
function CrowdA263000_Act06(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 2.5 - local0
function CrowdA263000_Act07(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA263000_Act11(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, 4, TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, -1)
    return 
end

function CrowdA263000_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_Turn, 2, TARGET_ENE_0, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end

function CrowdA263000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA263000_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA263000Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA263000Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA263000Battle_Interupt(arg0, arg1)
