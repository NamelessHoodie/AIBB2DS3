...
function OnIf_102070(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA_Spade102070_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

function CrowdA_Spade102070Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act06)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act11)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA_Spade102070_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 4.2 - local0
function CrowdA_Spade102070_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 3 - local0
function CrowdA_Spade102070_Act02(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = UPVAL0
...
local0 = 2.3 - local0
function CrowdA_Spade102070_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.2, 0, 3)
    end
...
local0 = 1.7 - local0
function CrowdA_Spade102070_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 2, 0, 3)
    end
...
local0 = 4.5 - local0
function CrowdA_Spade102070_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
local0 = 6.4 - local0
function CrowdA_Spade102070_Act06(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
...
function CrowdA_Spade102070_Act10(arg0, arg1, arg2)
...
function CrowdA_Spade102070_Act11(arg0, arg1, arg2)
...
function CrowdA_Spade102070_Act20(arg0, arg1, arg2)
...
function CrowdA_Spade102070_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA_Spade102070_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
function CrowdA_Spade102070Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA_Spade102070Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA_Spade102070Battle_Interupt(arg0, arg1)
