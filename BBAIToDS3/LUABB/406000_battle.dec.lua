...
function OnIf_406000(arg0, arg1, arg2)
    if arg2 == 0 then
        DeepOnesBig_NoWeapon_406000_ActAfter(arg0, arg1)
    end
    return 
end

function DeepOnesBig_NoWeapon_406000Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act08)
    local1[9] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act09)
    local1[21] = REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_Act21)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, DeepOnesBig_NoWeapon_406000_ActAfter_AdjustSpace), local2)
    return 
end

local0 = 6 - local0
function DeepOnesBig_NoWeapon_406000_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 6.4 - local0
function DeepOnesBig_NoWeapon_406000_Act02(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 11.6 - local0
function DeepOnesBig_NoWeapon_406000_Act03(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 6.2 - local0
function DeepOnesBig_NoWeapon_406000_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 5.2 - local0
function DeepOnesBig_NoWeapon_406000_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 9.2 - local0
function DeepOnesBig_NoWeapon_406000_Act06(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 16 - local0
function DeepOnesBig_NoWeapon_406000_Act07(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 25 - local0
function DeepOnesBig_NoWeapon_406000_Act08(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
local0 = 5.2 - local0
function DeepOnesBig_NoWeapon_406000_Act09(arg0, arg1, arg2)
    local local0 = UPVAL0
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, 0, 0, 3)
    end
...
function DeepOnesBig_NoWeapon_406000_Act21(arg0, arg1, arg2)
...
function DeepOnesBig_NoWeapon_406000_ActAfter(arg0, arg1)
...
function DeepOnesBig_NoWeapon_406000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function DeepOnesBig_NoWeapon_406000Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function DeepOnesBig_NoWeapon_406000Battle_Terminate(arg0, arg1)
    return 
end

function DeepOnesBig_NoWeapon_406000Battle_Interupt(arg0, arg1)
    local local0 = arg0:GetRandam_Int(1, 100)
    if arg0:IsLadderAct(TARGET_SELF) then
        ...
        elseif arg0:IsActivateSpecialEffect(TARGET_SELF, AI_SPEFFOBSERVE_SpEffId, 5026) then
            ...
            if arg0:IsFinishTimer(0) == true then
                if arg0:IsInsideTargetEx(TARGET_ENE_0, TARGET_SELF, AI_DIR_TYPE_F, 180, 6) then
                    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3004, TARGET_ENE_0, DIST_None, 0, 0)
                else
                    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3005, TARGET_ENE_0, DIST_None, 0, 0)
                end
                arg0:SetTimer(0, 10)
            else
        ...
        elseif Counter_Act(arg0, arg1, 4, 3020) then
            if 6 <= local4 then
                if local1 <= 50 then
                    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3007, TARGET_ENE_0, DIST_None, 0, 0)
                else
                    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3011, TARGET_ENE_0, DIST_None, 0, 0)
                    arg0:SetTimer(0, 10)
                end
            elseif 3 <= local4 then
                if local1 <= 50 then
                    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3008, TARGET_ENE_0, DIST_None, 0, 0)
                else
