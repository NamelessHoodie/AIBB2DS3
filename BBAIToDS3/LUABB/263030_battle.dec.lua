...
local local17 = 1
function OnIf_263030(arg0, arg1, arg2)
    if arg2 == 0 then
        CrowdA_Saber263030_ActAfter_RealTime(arg0, arg1)
    end
    return 
end

local0 = local17
function CrowdA_Saber263030Battle_Activate(arg0, arg1)
    local local0 = {}
    local local1 = {}
    local local2 = {}
    ...
    elseif arg0:GetNpcThinkParamID() == 263589 then
        local0[14] = 100
    ...
    local1[1] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act01)
    local1[2] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act02)
    local1[3] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act03)
    local1[4] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act04)
    local1[5] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act05)
    local1[6] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act06)
    local1[7] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act07)
    local1[8] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act08)
    local1[10] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act10)
    local1[11] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act11)
    local1[12] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act12)
    local1[13] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act13)
    local1[14] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act14)
    local1[20] = REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_Act20)
    Common_Battle_Activate(arg0, arg1, local0, local1, REGIST_FUNC(arg0, arg1, CrowdA_Saber263030_ActAfter_AdjustSpace), local2)
    return 
end
...
local0 = 2.6 - local0
local0 = 4.3 - local0
function CrowdA_Saber263030_Act01(arg0, arg1, arg2)
    local local0 = UPVAL0
...
local0 = 4.1 - local0
function CrowdA_Saber263030_Act02(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.5, 0, 3)
...
local0 = 2.1 - local0
function CrowdA_Saber263030_Act03(arg0, arg1, arg2)
...
local0 = 4.9 - local0
function CrowdA_Saber263030_Act04(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.5, 0, 3)
...
local0 = 4.1 - local0
function CrowdA_Saber263030_Act05(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.5, 0, 3)
...
local0 = 0.3 - local0
local0 = local17
function CrowdA_Saber263030_Act06(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
...
local0 = 3.3 - local0
local0 = 4 - local0
function CrowdA_Saber263030_Act07(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.5, 0, 3)
...
local0 = 4.7 - local0
function CrowdA_Saber263030_Act08(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.5, 0, 3)
...
function CrowdA_Saber263030_Act10(arg0, arg1, arg2)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = 10
...
local0 = local13
function CrowdA_Saber263030_Act13(arg0, arg1, arg2)
...
local0 = 7.3 - local0
function CrowdA_Saber263030_Act14(arg0, arg1, arg2)
    local local0 = UPVAL0
    local local1 = arg0:GetRandam_Int(1, 100)
    if local0 <= arg0:GetDist(TARGET_ENE_0) then
        Approach_Act(arg0, arg1, local0, UPVAL0 + 1.5, 0, 3)
...
function CrowdA_Saber263030_Act20(arg0, arg1, arg2)
...
function CrowdA_Saber263030_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_If, 10, 0)
    return 
end

function CrowdA_Saber263030_ActAfter_RealTime(arg0, arg1)
    local local0 = arg0:GetDist(TARGET_ENE_0)
    local local1 = arg0:GetRandam_Int(1, 100)
...
function CrowdA_Saber263030Battle_Update(arg0, arg1)
    return GOAL_RESULT_Continue
end

function CrowdA_Saber263030Battle_Terminate(arg0, arg1)
    return 
end

function CrowdA_Saber263030Battle_Interupt(arg0, arg1)
